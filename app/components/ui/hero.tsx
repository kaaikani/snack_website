...
export function Hero() {
  const buttonNew = (
   ...
   <Button asChild className="rounded-full bg-amber-500 px-6 text-black hover:bg-amber-400">
  <a
 ...
 <section className="relative isolate overflow-hidden">
  ...
  <img src="/KaaiKani-Logo.png" alt="Kaaikani Logo" width={96} height={96} className="h-16 w-full" />
  
  {/* I've changed the text to be more active and adjusted the color */}
  <p className="text-sm uppercase tracking-[0.25em] text-amber-600/90">Proudly Presents</p>
</div>
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            ...
            <span className="block text-amber-400 drop-shadow-[0_0_20px_rgba(245,158,11,0.45)]">DELIVERED FRESH</span>
...
const snackData = [
  {
    ...
    tone: "Celebration",
    videoSrc: "https://qiymdqxoteqad0st.public.blob.vercel-storage.com/Laddu.webm",
  },
  {
    title: "Freshly Made",
    sub: "Prepared daily, delivered fresh.",
    tone: "Freshness",
    videoSrc: "https://qiymdqxoteqad0st.public.blob.vercel-storage.com/Chef%281%29.webm",
  },
  {
    title: "Share the Joy",
    sub: "Perfect for gifting and parties.",
    tone: "Gifting",
    videoSrc: "https://qiymdqxoteqad0st.public.blob.vercel-storage.com/happy%281%29.webm",
  },
  {
    title: "Authentic Taste",
    sub: "Traditional recipes passed down generations.",
    tone: "Tradition",
    videoSrc: "https://qiymdqxoteqad0st.public.blob.vercel-storage.com/devontional.webm",
  },
  {
    title: "Our Collection",
    sub: "Explore our wide range of sweets.",
    tone: "Variety",
    videoSrc: "https://qiymdqxoteqad0st.public.blob.vercel-storage.com/snacksshowcase%281%29.mp4",
  },
]